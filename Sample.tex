...
\email{iliparti@smith.edu} % optional
\altaffiliation[Box 8345 Smith College]{1 Chapin Way, 
  Northampton, MA, USA} % optional second address
% If there were a second author at the same address, we would put another 
% \author{} statement here.  Don't combine multiple authors in a single
% \author statement.
\affiliation{Department of Physics, Smith College Northampton, MA 01063-6302}
...
\begin{abstract}
Hi, my name is Isabel and I like seals.  Frances probably also likes seals because they are awesome.
\end{abstract}
...
Before we get started, I just want to say Freeman Dyson was a true seal expert, as evidenced by this article \cite{Dyson}.  I think he would like to see Fig. \ref{MyGreatData} because seals like gas bulb data.  Here is an equation commonly used by seal physicists:  $ E=Mc^2 $.  Do seals have a favorite math equation?  They probably like Eq. \ref{trigequation} .
...
\centering
\includegraphics{MyGreatData.pdf}
